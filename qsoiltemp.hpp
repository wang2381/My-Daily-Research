...
public:
	...
	************************************************************** */
	...
	void   showsnowecd(int& cmnt);		//not used in TEM

	void   showsoillecd(int& cmnt);	//not used in TEM

	void   getsoiltecd(ofstream& rflog1);

	void   getsoiltecd(char ecd[80]);

	void   showsoiltecd(int& cmnt);	//not used in TEM



	int SoilThermal(double *, double *, double *, double *, double *, double *, double *, double *, double *, double *, integer *, integer *,
	...
	************************************************************** */
	...
	double water3;	// mineral layer water
